# Contributing to blackroad-os-simple-launch
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-os-simple-launch.git
cd blackroad-os-simple-launch

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-os-simple-launch.git
